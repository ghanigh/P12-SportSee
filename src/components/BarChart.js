...
/**
 * Composant BarCharts
 * Rend un graphique en barres avec les données d'activité de l'utilisateur.
 * @return {JSX}
 */
export default function BarCharts() {
    ...
    // Si aucune donnée n'est disponible, retourne null
    if (data.length === 0) return null;

    // Formatage de la propriété "day" dans les données
